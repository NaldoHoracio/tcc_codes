# -*- coding: utf-8 -*-
"""
Created on Thu Mar 12 10:15:56 2020

Técnica: Regressão Linear aplicado a dados em Alagoas
...
for train_index_al, test_index_al in kf_cv_al.split(features_al):
    ...
    #importance_fields_aux_al = dt_al.feature_importances_
...
# QE_I01
fig1 = plt.figure();
fig1.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I01_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I02
fig2 = plt.figure();
fig2.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.xlabel('Variável');
plt.title('Cor/raça');
plt.savefig('QE_I02_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I03
fig3 = plt.figure();
fig3.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I03_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I04
fig4 = plt.figure();
fig4.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I04_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I05
fig5 = plt.figure();
fig5.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I05_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I06
fig6 = plt.figure();
fig6.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I06_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I07
fig7 = plt.figure();
fig7.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I07_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I08
fig8 = plt.figure();
fig8.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I08_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I09
fig9 = plt.figure();
fig9.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I09_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I10
fig10 = plt.figure();
fig10.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I10_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I11
fig11 = plt.figure();
fig11.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I11_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I12
fig12 = plt.figure();
fig12.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I12_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I13
fig13 = plt.figure();
fig13.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I13_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I14
fig14 = plt.figure();
fig14.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I14_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I15
fig15 = plt.figure();
fig15.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I15_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I16
fig16 = plt.figure();
fig16.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I16_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I17
fig17 = plt.figure();
fig17.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I17_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I18
fig18 = plt.figure();
fig18.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I18_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I19
fig19 = plt.figure();
fig19.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I20_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I20
fig20 = plt.figure();
fig20.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.ylabel('Importância'); 
plt.xlabel('Variável');
plt.title('Grupo determinante para enfrentar as dificuldades do curso e concluí-lo - Árvore de Decisão');
plt.savefig('QE_I20_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I21
fig21 = plt.figure();
fig21.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I21_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I22
fig22 = plt.figure();
fig22.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I22_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I23
fig23 = plt.figure();
fig23.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I23_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I24
fig24 = plt.figure();
fig24.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I24_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I25
fig25 = plt.figure();
fig25.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I25_AL_DT.png', dpi=450, bbox_inches='tight');

#%%
# QE_I26
fig26 = plt.figure();
fig26.suptitle('Método: Árvore de Decisão', fontsize=10, fontweight='bold')
...
plt.savefig('QE_I26_AL_DT.png', dpi=450, bbox_inches='tight');
...
plt.savefig('01_13_AL_DT.png', dpi=450, bbox_inches='tight');
...
plt.savefig('13_26_AL_DT.png', dpi=450, bbox_inches='tight');