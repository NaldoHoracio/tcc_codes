...
df_qe_aux = pd.DataFrame([["QE_I01", "Estado civil","A:Solteiro(a)"],
          ...
          ["QE_I03",  "Nacionalidade?","B:Brasileira naturalizada"],
          ["QE_I03",  "Nacionalidade?","C:Estrageira"],
          ...
          ["QE_I12", "Tipo de bolsa de permanência durante da graduação","D:Aux.moradia e alimentação"],
